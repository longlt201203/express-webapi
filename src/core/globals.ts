...
export default class Globals {
	...
	// Swagger
	static readonly SWAGGER_DOCS_PATH =
		process.env.SWAGGER_DOCS_PATH || "/swagger";

	// Upload
	static readonly UPLOAD_FOLDER_DEFAULT_PATH =
		process.env.UPLOAD_FOLDER_DEFAULT_PATH || "upload";
